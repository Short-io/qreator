...
exports.getMatrix = exports.calculatePenalty = exports.fillData = exports.fillReserved = exports.fillStub = exports.fillAlignAndTiming = exports.fillFinders = exports.init = void 0;
...
exports.fillFinders = fillFinders;
...
exports.fillAlignAndTiming = fillAlignAndTiming;
...
exports.fillStub = fillStub;
exports.fillReserved = (function () {
...
function getMatrix(data) {
    ...
    for (let mask = 0; mask < 8; mask++) {
        exports.fillData(matrix, data, mask);
        exports.fillReserved(matrix, data.ec_level, mask);
    ...
    exports.fillData(matrix, data, bestMask);
    exports.fillReserved(matrix, data.ec_level, bestMask);
