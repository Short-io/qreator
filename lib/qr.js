...
function qr_image(text, options) {
    ...
    case 'eps':
        process.nextTick(function() {
            vector[options.type](matrix, stream, options.margin, options.size, options.logo, options.logo_width, options.logo_height);
        });
        break;
    case 'svgpath':
        // deprecated, use svg_object method
        process.nextTick(function() {
            var obj = vector.svg_object(matrix, options.margin, options.size, options.logo, options.logo_width, options.logo_height);
